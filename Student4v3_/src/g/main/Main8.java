...
//		list.add(s1.setGrade(85.3));  // ça ne marche pas, parce que setGrade ne retourne rien.
	...
	// ===============================================
		System.out.println("Test du Comparteur null");
		System.out.println();
		
		System.out.println("ArrayList sorted by id  (Student default order)");
		MySort.sort(list, null);   
		for(Student a: list)
			System.out.println(a);
		System.out.println();
						
		System.out.println("ArrayList sorted by id  (Student default order - reversed)");
		MySort.sort(list, MySort.reverseOrder(null));   
		for(Student a: list)
			System.out.println(a);
		System.out.println();
		...
		System.out.println("ArrayList sorted by id  (Student default order - reversed)");
		MySort.sort(list, Collections.reverseOrder(null));   
		for(Student a: list)
			System.out.println(a);
		System.out.println();	
	}
