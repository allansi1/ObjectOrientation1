...
//		MySort.sort(list, Collections.reverseOrder());   
//		for(Student a: list)
//			System.out.println(a);
//		System.out.println();
		...
		/*
		 * Si la list (la collection) contient des éléments null,
		 * et le comparator (ni notre MySort.sort) ne traite pas la 
		 * condition des éléments null, 
...
//		System.out.println();
		...
		System.out.println("ArrayList sorted by id  (Student default order)");
		MySort.sort(list, Comparator.nullsLast((o1,o2)->o1.compareTo(o2)));   
		for(Student a: list)
			System.out.println(a);
		System.out.println();
		...
		System.out.println("ArrayList sorted by name");
		MySort.sort(list, Comparator.nullsLast(new NameComparator())); 
		for(Student a: list)
			System.out.println (a);
		System.out.println();
		
		System.out.println("ArrayList sorted by name (comparator internal class)");
		MySort.sort(list, Comparator.nullsLast(new Student.NameComparator2())); 
		for(Student a: list)
			System.out.println (a);
		System.out.println();
		
		System.out.println("ArrayList sorted by grade");
		MySort.sort(list, Comparator.nullsLast(new GradeComparator())); 
		for(Student a: list)
			System.out.println (a);
		System.out.println();
