...
//}
	...
	/*
	 * Nous pouvons aussi définir des "comparators" commme des 
	 * classes interne statique, bien que ce soit préférable de 
	 * les définir comme des classes / fichiers separées dans le 
	 * même paquet.
	 * */
	static public class NameComparator2 implements Comparator<Student>{
		
		/* Nous pouvons créer des "comparators" comme des classes interne statique publique,  
		 * cependant, cela n'est pas considérer la meilleur pratique. 
		...
		public int compare(Student s1, Student s2) {
			...
			/*
			 * Si les noms sont egaux, on compare les prénoms (givenName) en utilisant le
			 * compareTo de String
			 */
			if (r == 0) {
